...
from heare.developer.tools.shell import (
    shell_execute,
...
def context():
    ...
    try:
        from heare.developer.tools.tmux_tool import tmux_destroy_all_sessions
...
class TestShellSessions:
    ...
    async def test_session_timeout_configuration(self, context):
        ...
        # Set timeout
        result = shell_session_set_timeout(context, "timeout_session", 45)
